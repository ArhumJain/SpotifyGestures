...
class TokenValidator():    
    def __init__(self):
        with open(os.path.join(os.path.dirname(os.path.dirname(__file__)), "data", "VARS.json"), "r") as f: self.VARS = json.load(f)

        self.BASE_URL = "api.spotify.com"
        self.USER_AGENT = self.VARS["USER_AGENT"]
        self.FILE_PATH = os.path.join(os.path.dirname(os.path.dirname(__file__)), "data", "OAuth.json")
